...
contextBridge.exposeInMainWorld('musicToDiscord', {
  ...
  getRecentAlbums: () => ipcRenderer.invoke('get-recent-albums'),
  getArtistSpotlight: () => ipcRenderer.invoke('get-artist-spotlight'),
  getPlayCountGoal: () => ipcRenderer.invoke('get-play-count-goal'),
  getPet: () => ipcRenderer.invoke('get-pet'),
  petClean: () => ipcRenderer.invoke('pet-clean'),
